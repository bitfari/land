...
import { nftsLargeImgs } from "contains/uiData";
    ...
    return (
      <div className="divide-y divide-neutral-100 dark:divide-neutral-800">
        ...
        <div className="pb-9 space-y-5">
          ...
          <span className="text-sm">Liberty Island</span> &nbsp; | &nbsp;
          <span className="text-sm">40°41′20″N 74°02′40″W</span>
