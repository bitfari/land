...
import { CRSD }  from 'Constants';
import alertImg from "images/alert-icon.png";
 
 
export default function OsmIdApi(props) { 
...
function errMsg(){
   ...
   if (!apiData.length){
    return (
      ...
      <Fragment>
        ...
        The Property You Search For Can't Be Minted Today.
        </h2> 
   ...
   if (hasWikipedia) {
    ...
    return (
      ...
      <Helmet>
        ...
        <div className="pb-9 space-y-5">
          ...
          <a href={'https://www.openstreetmap.org/way/' + catalog.id.toString()}> 
          ...
          <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-8 text-sm">
            <div className="flex items-center ">
              <span className="ml-2.5 text-neutral-500 dark:text-neutral-400 flex flex-col">
                <span className="text-sm">OSM WAY#</span>
                <span className="text-neutral-900 dark:text-neutral-200 font-medium flex items-center">
                  <span><b><a href={'https://www.openstreetmap.org/way/' + catalog.id.toString()}>{catalog.id.toString()}</a></b></span>
        ...
        <div><strong><a href={'https://www.openstreetmap.org/way/' + catalog.id.toString()} 
        ...
        <div className="pb-9 pt-14">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between">
            ...
            {(catalog.id===11199999999) ? (<b> 100 nfts <br/></b>) : ("[Unique]")}
            </span>
          </div>
    ...
    <div>
      ...
      {housenumber ? (<b> housenumber: {housetag} <br/></b>) : (" ")}
      {street ? (<b> street: {streetname} <br/></b>) : (" ")}
    </div>
    <br/>
