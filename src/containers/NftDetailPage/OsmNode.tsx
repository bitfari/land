...
export default function OsmNodeApi(props) { 
...
function errMsg(){
   ...
   if (!apiData.length){
    ...
    if (catalog.description){
     ...
     for(i=0; i < theTags.length; i++){
         if ((theTags[i] === 'name') || (theTags[i] === 'official_name') ){
           j=i;
           hasName= true; }
     }
   ...
   if (hasWikipedia) {
    ...
    return (
      ...
      <Helmet>
        <title>DL: {name} | OSM {catalog.osm_id.toString()} | Digital Land</title>
      </Helmet>
        ...
        <div className="pb-9 space-y-5">
          ...
          <a href={'https://www.openstreetmap.org/node/' + catalog.osm_id.toString()}> 
          <h3 className="text-1xl sm:text-1l lg:text-2l font-semibold"> 
          Bitfari Virtual Billboard on this Point
          </h3>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold"> 
          {name} 
          </h2>
          ...
          &nbsp;<span className="text-sm">osm.btc</span> . <span className="text-sm">geofence.btc</span>         
          {/* ---------- 4 ----------  */}
          <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-8 text-sm">
            <div className="flex items-center ">
              <span className="ml-2.5 text-neutral-500 dark:text-neutral-400 flex flex-col">
                <span className="text-sm">OSM NODE#</span>
                <span className="text-neutral-900 dark:text-neutral-200 font-medium flex items-center">
                  <span><b><a href={'https://www.openstreetmap.org/node/' + catalog.osm_id.toString()}>{catalog.osm_id.toString()}</a></b></span>
        ...
        <div><strong><a href={'https://www.openstreetmap.org/node/' + catalog.osm_id.toString()} 
        target='_blank'>Click Here and See the Point on a Map!</a></strong></div>
